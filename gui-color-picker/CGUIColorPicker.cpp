...
namespace irr
{
    ...
    namespace gui
    {
        CGUIColorPicker::CGUIColorPicker(IGUIEnvironment *environment, IGUIElement *parent, s32 id, bool uad) noexcept
        ...
        void CGUIColorPicker::setEnabled(bool c)
        {
            close->setEnabled(c);
            scroll->setEnabled(c);
            for(int i = 0; i< 6; ++i)
        ...
        IGUIButton *CGUIColorPicker::getCloseButton() const noexcept
        {
            return close;
        }
        IGUIButton *CGUIColorPicker::getExtendButton() const noexcept
        {
            return extend;
        }
        ...
        void CGUIColorPicker::setAdvenced(bool i) noexcept
        {
            IGUISkin *skin = Environment->getSkin();
            isExtended = i;
        ...
        bool CGUIColorPicker::getAdvenced() const noexcept
        {
            return isExtended;
        }
        ...
        void CGUIColorPicker::setScrollValueHSV(bool set, int h, int s, int v) noexcept
        {
            core::stringw value;
        ...
        void CGUIColorPicker::setScrollValueRGB(bool set, int r, int g, int b) noexcept
        {
            core::stringw value;
        ...
        void CGUIColorPicker::updateFromScroll(bool HsvOrRgb) noexcept
        {
            if(HsvOrRgb)
            {
        ...
        void CGUIColorPicker::recalculateAdvenced() noexcept
        {
            if(!isExtended)
                return;
        ...
        void CGUIColorPicker::setSelectedColor(const video::SColor &b) noexcept
        {
            selectcolor = b;
        }
        const video::SColor& CGUIColorPicker::getSelectedColor() const noexcept
        {
            return selectcolor;
        }
